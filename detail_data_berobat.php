                ...
                <div class="panel-body table-responsive no-padding">
                  <div class="col-xs-12 control">
                    <table id="example1" class="table table-bordered table-striped">
                      <thead>
                        <tr>
                          <th style="text-align: center;border: 1px solid gray;">No</th>
                        ...
                        ?>
                            <tr>
                              ...
                              <td style="text-align: center;border: 1px solid gray;vertical-align : middle;">
                                  <a href="hapus_detail_berobat?id=<?php echo $row->id_detail_berobat; ?>" class="btn btn-danger btn-sm ">Hapus</a>
                              </td>
                            </tr>
                        <?php  }
                        } ?>
