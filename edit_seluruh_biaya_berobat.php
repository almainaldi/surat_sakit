        ...
        <div class="col-xs-12">
            <div class="box box-info">
                <div class="box-header with-border">
                    <h3 style="text-align: center;">Edit Data Biaya Berobat</h3>
                </div>
                <form id="form" class="form-horizontal" method="post" action="">
                    <form class="form-horizontal">
                        <div class="box-body">
                            <table>
                                <tbody>
                                    ...
                                    <tr>
                                        ...
                                        <th style="width: 15%">:</th>
                                        <th style="width: 60%">
                                            <input type="text" name="dokter" id="dokter" class="form-control" <input type="text" class="form-control" value="<?php echo $data['dokter']; ?>" onkeyup="this.value = this.value.toUpperCase()" autocomplete="off" autofocus required oninvalid="this.setCustomValidity('Data Tidak Boleh Kosong')" oninput="setCustomValidity('')">
                                        </th>
                                    </tr>
                                    <!-- ENTER -->
                                    <tr>
                            ...
                            <input type="hidden" name="tgl_in" value="<?php echo date('Y-m-d')?>">
                        </div>
