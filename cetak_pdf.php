...
$html = '<html><head><link rel="stylesheet" href="assets/master/bower_components/bootstrap/dist/css/bootstrap.min.css"></head><body><table><tbody><tr><td align="center"><strong>RINCIAN BIAYA BEROBAT</strong></td></tr>';
$html .= '</tbody><br><tbody>
<tr>
	<td width="150px">Tanggal Berobat</td>
	<td width="10px">:</td>
	<td width="350px">' . $data['tanggal'] . '</td>
</tr>
<tr>
	<td width="150px">Nama Karyawan</td>
	<td width="10px">:</td>
	<td width="350px">' . $data['nama_karyawan'] . '</td>
</tr>
<tr>
	<td width="150px">Jenis Penyakit</td>
	<td width="10px">:</td>
	<td width="350px">' . $data['jenis'] . '</td>
</tr>
<tr>
	<td width="150px">Nama Klinik</td>
	<td width="10px">:</td>
	<td width="350px">' . $data['tempat'] . '</td>
</tr>
<tr>	
	<td width="150px">Dokter</td>
	<td width="10px">:</td>
	<td width="350px">' . $data['dokter'] . '</td>
</tr>
<tr>
	<td width="150px">Kasbon</td>
	<td width="10px">:</td>
	<td width="350px">Rp. ' . number_format($data['kasbon'], 0, "", ".") . '</td>
</tr>
</tbody></table><br><br>';
...
if ($data_detail_data_berobat->num_rows > 0) {
	while ($row = mysqli_fetch_object($data_detail_data_berobat)) {
		$html .= '<tbody><tr style="vertical-align : middle;text-align:center; font-size: 14px;">
									<th width="5%">' . $no . '</th>
									<th width="40%">' . $row->jenis_layanan . '</th>
									<th width="40%">Rp. ' . number_format($row->biaya, 0, "", ".") . '</th>
								</tr>';
		$no++;
	}
}
...
<th colspan="1" style="vertical-align : middle;text-align:right;">Rp. ' . number_format($total_biaya, 0, "", ".") . '</th>
</tr>
</tbody>';
...
$pdf_name = 'Biaya Berobat ' . $data['tanggal'] . ' ' . $data['nama_karyawan'] . '.pdf';
// $pdf->Ln(5);
