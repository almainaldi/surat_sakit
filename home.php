...
$jumlah_sr_on_proses     = $home->jumlah_sr_on_proses();
$jumlah_biaya_berobat     = $home->jumlah_biaya_berobat();
$jumlah_rekam_medis     = $home->jumlah_rekam_medis();
$jumlah_batal_berobat     = $home->jumlah_batal_berobat();
...
<div class="content-wrapper">
     <section class="content">
          <div class="row">
               ...
               <div class="col-lg-2 col-xs-6">
                    <div class="small-box" style="background-color: #E1CC8D;border-radius: 10px;">
                         <div class="inner">
                              <h3><?php echo $jumlah_sr_on_proses ?></h3>
                              <p><i class="fa fa-refresh"></i> Surat Rujukan On Proses</p>
                         </div>
                         <a href="tampil_surat_rujukan_on_proses" class="small-box-footer text-black" style="border-radius: 10px;">More info <i class="fa fa-arrow-circle-right"></i></a>
                    </div>
               </div>
               <!-- SPK SERVIS -->
               <div class="col-lg-2 col-xs-6">
               ...
               <div class="col-lg-2 col-xs-6">
                    <div class="small-box" style="background-color: #42F2E7; border-radius: 10px;">
                         <div class="inner">
                              <h3><?php echo $jumlah_batal_berobat ?></h3>
                              <p><i class="fa fa-remove"></i> Total Batal Berobat</p>
                         </div>
                         <a href="tampil_batal_surat_rujukan" class="small-box-footer text-black" style="border-radius: 10px;">More info <i class="fa fa-arrow-circle-right"></i></a>
                    </div>
               </div>
          </div>
     </section>
