...
<div class="content-wrapper" id="content">
    ...
    <section class="invoice" style="font-size: 18px; font-family: Verdana, Geneva, Tahoma, sans-serif;">
        ...
        <div class="row">
            ...
            <div class="col-xs-12">
                ...
                <table>
                    ...
                    <tr>
                        <td><b>Diberikan izin berobat ke <?php echo $data['tujuan'] ?> untuk dapat diperiksa oleh dokter dan diberi obat sesuai penyakit yang diderita.</b></td>
                    </tr>
                </table>
                <tr>
                    <th>
        ...
        <table class="table" style="font-size:18px;">
            ...
            <td class="text" style="vertical-align : middle;text-align:center;" scope="col"> <br> <br> <br> </td>
            <td class="text" style="vertical-align : middle;text-align:center;" scope="col"> <br> <br> <br> </td>
            <td class="text" style="vertical-align : middle;text-align:center;" scope="col"> <br> <br> <br> </td>
            </tr>
            <tr>
                <th><?php echo $data['mengetahui'] ?></th>
                <th></th>
                <th></th>
                <th></th>
                <th></th>
        ...
        <div class="row no-print">
            <div class="col-xs-12">
                <a href="tampil_seluruh_surat_rujukan" class="btn btn-warning pull-left"><i class="fa fa-backward"></i> Kembali</a>
