        ...
        <div class="col-xs-12">
            <div class="box box-info">
                <div class="box-header with-border">
                    <h3 style="text-align: center;">Tambah Data Rekap Medis</h3>
                </div>
                <form id="form" class="form-horizontal" method="post" action="">
                    <form class="form-horizontal">
                            ...
                            <table>
                                <tbody>
                                    ...
                                    <tr>
                                        ...
                                        <th style="width: 10%">:</th>
                                        <th style="width: 60%">
                                            <textarea class="form-control" name="keluhan" id="keluhan" placeholder="Input Keluhan" rows="5" onkeyup="this.value = this.value.toUpperCase()" autocomplete="off" placeholder="Input Keluhan" autofocus oninvalid="this.setCustomValidity('Data Tidak Boleh Kosong')" oninput="setCustomValidity('')"> </textarea>
                                        </th>
                                    </tr>
                                    <!-- ENTER -->
                                    <!-- ENTER -->
                        ...
                        <div class="box-footer">
                            <a href="tampil_seluruh_biaya_berobat" button onclick="window.close()" class="btn btn-warning pull-left">Kembali</a>
                            <button type="submit" name="rekap" class="btn btn-primary pull-right">Simpan</button>
                        </div>
            </div>
        </div>
</section>
