        ...
        <div class="col-xs-12">
            <div class="box box-info">
                <div class="box-header with-border">
                    <h3 style="text-align: center;">Tambah Memo Rekap Berobat</h3>
                </div>
                <form id="form" class="form-horizontal" method="post" action="">
                    <form class="form-horizontal">
                            ...
                            <table>
                                <tbody>
                                    ...
                                    <tr>
                                        ...
                                        <th style="width: 60%">
                                        <input type="text" name="" class="form-control" value="<?php echo $data['nama_kar']; ?>" readonly>
                                        </th>
                                    </tr>
                                    <!-- ENTER -->
                                    <tr>
                                    ...
                                    <tr>
                                        ...
                                        <th style="width: 15%">:</th>
                                        <th style="width: 60%">
                                            <textarea class="form-control" name="memo" id="memo" placeholder="Input Memo" rows="5" onkeyup="this.value = this.value.toUpperCase()" autocomplete="off" autofocus required oninvalid="this.setCustomValidity('Data Tidak Boleh Kosong')" oninput="setCustomValidity('')"><?php echo $data['memo']; ?></textarea>
                                        </th>
                                    </tr>
                                    <!-- ENTER -->
                                    <tr>
                        ...
                        <div class="box-footer">
                            ...
                            <a href="tampil_rekap_berobat" button onclick="window.close()" class="btn btn-warning pull-left">Kembali</a>
                            <button type="submit" name="updatein" class="btn btn-info pull-right"> Simpan</button>
                        </div>
            </div>
        </div>
</section>
