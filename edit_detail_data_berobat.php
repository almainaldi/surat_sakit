...
<body>
    ...
    if (isset($_POST['tombol'])) {
        ...
        if ($detail_data_berobat->tambah($data)) {
            ...
            header("location:detail_data_berobat?pesan=gagal");
        }
    }
    ...
    <div class="content-wrapper">
        <section class="content-header">
            <h1>
                Edit Detail Biaya Berobat
            </h1>
            <ol class="breadcrumb">
                <li><a href="home"><i class="fa fa-dashboard"></i> Home</a></li>
                <li class="active">Edit Detail Biaya Berobat</li>
            </ol>
        </section>
                    ...
                    <div class="box box-info">
                        ...
                        <form id="form" class="form-horizontal" method="post" action="">
                                            ...
                                            <tbody>
                                                ...
                                                ?>
                                                        <tr>
                                                            ...
                                                            <td style="text-align: center;border: 1px solid gray;vertical-align : middle;">Rp. <?php echo number_format($row->biaya, 0, "", ".") ?></td>
                            ...
                            <form id="form1" class="form-horizontal" method="post" action="">
                                <!-- END NO KENDARAAN -->
                                <div class="form-group"></div>
                                <h4 style="color: red;margin-left: 20px; font-size: 15px;">Note :<i>Tombol Hapus pada tabel detail biaya dan Kolom Input Detail Biaya Berobat 
                                    <br> masih muncul sebelum alur rekap medis di selesaikan
                                </i></h4>
                                <hr>
                                <?php if ($data['status']>='1') {?>
                                <h4 style="color: red;margin-left: 20px; font-size: 15px;"><i> Jika ada kesalahan input setelah klik tombol selesai pada rekap medis Harap
                                <br>Hubungi Team IT Terimakasih
                                </i></h4>
                                <?php }?>
