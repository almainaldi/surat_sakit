                ...
                <form id="form" class="form-horizontal" method="post" action="">
                    <form class="form-horizontal">
                        <div class="box-body">
                            <table>
                                <tbody>
                                    <tr>
                                        ...
                                        <th style="width: 60%">
                                            <input type="text" name="tgl" class="form-control tanggal" value="<?php echo $data_surat['tgl']; ?>" >
                                    ...
                                    <tr>
                                        ...
                                        <th style="width: 10%">:</th>
                                        <th style="width: 60%">
                                            <input type="text" name="dokter" id="dokter" class="form-control" onkeyup="this.value = this.value.toUpperCase()" autocomplete="off" placeholder="Input Dokter" autofocus oninvalid="this.setCustomValidity('Data Tidak Boleh Kosong')" oninput="setCustomValidity('')">
                                        </th>
                                    </tr>
                                    <!-- ENTER -->
                                    <tr>
                                    ...
                                    <tr>
                                        ...
                                        <th style="width: 10%">:</th>
                                        <th style="width: 60%">
                                            <input type="text" name="jenis" id="jenis" class="form-control" onkeyup="this.value = this.value.toUpperCase()" autocomplete="off" placeholder="Input Jenis Penyakit" autofocus oninvalid="this.setCustomValidity('Data Tidak Boleh Kosong')" oninput="setCustomValidity('')">
                                        </th>
                                    </tr>
                                    <!-- ENTER -->
                                    <tr>
                                    ...
                                    <tr>
                                        ...
                                        <th style="width: 15%">:</th>
                                        <th style="width: 60%">
                                            <input type="number" name="kasbon" id="kasbon" class="form-control" autocomplete="off" placeholder="Input Kasbon">
                                        </th>
                                    </tr>
                                    <!-- ENTER -->
                                </tbody>
                            ...
                            <input type="hidden" name="id_berobat" class="form-control" value="">
                        ...
                        <div class="box-footer">
                            ...
                            <a href="" button onclick="window.close()" class="btn btn-primary pull-left">Close</a>
